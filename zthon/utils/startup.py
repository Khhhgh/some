    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/f7b70784a7f6d0b74f46f.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس نيون الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝐬𝐨𝐮𝐫𝐜𝐞 NEON", "https://t.me/SOURCE_NEON"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "NEON SOURCE")
...
zthon = {"@SOURCE_NEON", "@SOURCE_NEONe1", "@Tws_SOURCE_NEON", "@P17_12", "@SOURCE_NEON_Help"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/SOURCE_NEON.jpg")
