...
@zedub.ar_cmd(
    ...
    info={
        "header": "Source code link of VENOM",
        "usage": [
            "{tr}repo",
        ],
    },
...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "اضغط [هنا](t.me/RB_RO) لفتح قناة السورس\
        \nاضغط [هنا](t.me/R_N_B1) جروب الدعم",
    )
...
@zedub.ar_cmd(
    ...
    info={
        ...
        "description": "It uploads the given file to your github repo in **zedub/plugins** folder\
...
async def git_commit(file_name, mone):
    ...
    if create_file:
        file_name = f"zthon/plugins/{file_name}"
        LOGS.info(file_name)
        try:
            repo.create_file(
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your PLUGINS](https://github.com/{ccess}/tree/master/zedub/plugins/)"
            )
