...
async def zed(event):
    await edit_or_reply(event, "[𝐒𝐎𝐔𝐑𝐂𝐄 𝐍𝐄𝐎𝐍 - اوامــر قوائم المساعد والقوائم الاخري  🪬](t.me/source_neon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n**⎉╎قـائمـة اوامر القوائم والاضافه  بسـورس نيون🦾 :** \n\n**- اولاً اوامــر  هي :**\n\n**⎞𝟏⎝** `.رشق مشاهدات`\n**⪼   مع رابط الفيديو  ✓**\n\n\n**⎞𝟐⎝** سيتم اضافة المزيد من الخيارات قريبا**\n\n\n 𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐍𝐄𝐎𝐍](t.me/source_neon) 𓆪")
