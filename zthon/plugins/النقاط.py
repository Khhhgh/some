...
ZelzalCoins_cmd = (
    "[ᯓ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐍𝐄𝐎𝐍 - اوامـر تجميـع النقـاط](tmme/SOURCE_NEON) 𓆪\n\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @W_4_7**"
)
