                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @A_D_P\
                                  \n\n--------بـدء تتبـع سجـل نيون NEON--------\
                        ...
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/A_D_P)"
                        text = (
                            "**✘ تقـريـر إشعـار نيون c ✘**\n\n"
